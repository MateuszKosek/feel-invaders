...
public class EnemyManager : MonoBehaviour
{
    ...
    public void MoveEnemiesIn()
    {
        StartCoroutine(MoveEnemiesInInternal());
    }

    public IEnumerator MoveEnemiesInInternal()
    {
        CreateGrid();
        ...
        {
            EnemyScript enemy = slot.currentEnemy;
            if (!enemy)
                continue;

            enemy.TweenMoveIn(i * 0.016f + UnityEngine.Random.Range(-0.1f, 0.1f), () => { slot.MoveUpDown(0); });
    ...
    public void MoveEnemiesOut()
    {
        ...
        foreach (var slot in slots)
        {
            ...
            enemy.TweenMoveOut(1 + i * 0.03f + UnityEngine.Random.Range(-0.4f, 0.4f), null);
